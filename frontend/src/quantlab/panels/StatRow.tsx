...
export function StatRow({ metrics }: { metrics: PerformanceMetrics }) {
  return (
    <div data-testid="stat-row" className="grid grid-cols-2 gap-x-8 gap-y-4 sm:grid-cols-4">
      ...
      <Stat label="Win rate" hint="Share of closed trades that gained. Open positions do not count.">
